                             ...
                             vector<cv::Point3f> &vP3D, vector<bool> &vbTriangulated)
{
    ...
    // RANSAC Iterate! => Create 'mMaxIterations vectors' of size 8.
    for(int it=0; it<mMaxIterations; it++)
    {
        ...
        for(size_t j=0; j<8; j++)
        {
            ...
            // Fill the selected index with the last element and pop_back the last element. Genius...
                            ...
                            cv::Mat &R21, cv::Mat &t21, vector<cv::Point3f> &vP3D, vector<bool> &vbTriangulated, float minParallax, int minTriangulated)
{
    ...
    // Error : 1. Too hard 50   2. Too high 1.0
    if(maxGood==nGood1)
    {
...
#ifdef DEBUG
    cout << "d1,d2,d3("<< d1 << ',' << d2 << ',' << d3 << ")-";
    cout << "x1,x2(" << aux1 << ',' << aux3 << ")-";
#endif
